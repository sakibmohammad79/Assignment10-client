    ...
    return (
       <div>
        ...
        <Container className='text-center'>
            <img src={logo1} alt="" />
            <img className='px-4 px-md-5' src={logo2} alt="" />
            <img src={logo3} alt="" />
            <img className=' px-3 px-md-5 ' src={logo4} alt="" />
            <img className='mt-3 ' src={logo5} alt="" />
            <img className='mt-3 px-3 px-md-5' src={logo6} alt="" />
        </Container>
       </div>
    );
};
